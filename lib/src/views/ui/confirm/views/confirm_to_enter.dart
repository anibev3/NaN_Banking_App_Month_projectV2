...
class ConfirmPinToEnter extends StatefulWidget {
  // final VoidCallback onSuccess;
  const ConfirmPinToEnter({
    Key? key,
    // required this.onSuccess,
  }) : super(key: key);

  @override
  State<ConfirmPinToEnter> createState() => _ConfirmPinToEnterState();
}

class _ConfirmPinToEnterState extends State<ConfirmPinToEnter> {
...
//
  ...
  void confirmTransactionUsingPin() {
    ...
    confirmController.confirmPinBeforeTransfer(
      context: context,
      pin: pin,
      // username: username,
      // onSuccess: () {
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text(
                  "${confirmController.userNawariPRENOM} ${confirmController.userNawariNOM}",
                  style: TextStyle(
