...
class InfoSupScreen extends StatelessWidget {
  ...
  String uid_local = 'www';

  String email_local = 'ww';

  String contact_local = 'ww';

  // @override
  // void initState() {
  //   super.initState();
  // uid_local = box.read("userNawariIdTEMPOM");
  // email_local = box.read("userNawariEMAIL");
  // contact_local = box.read("userNawariCONTACT");
  // }
  ...
  Future creatCustomer({required Customer customer}) async {
    ...
    if (customer.nom != "" &&
      ...
      if (docUserLengthRef != null) {
        ...
        await box.write('userNawariEMAIL', email_local);
        ...
        await box.write('userNawariCONTACT', contact_local);
        await box.write('userNawariPIECE', customer.numPce);
        await box.write('userNawariID2', uid_local);
        await Flushbar(
          backgroundColor: Colors.green,
          title: "Erreur",
